...
def merge_old_with_new(old, new):
    ...
    """Definition"""
    if new.get('definition') and len(new):
...
def main():
    ...
    batch_ids = list(new_label_data)#[:] #DEBUG
    seg_length = 50
