...
Examples:
    python3 simple_scicrunch_client.py export INTERLEX_API_KEY=$(cat path/to/my/api/key)
    python3 simple_scicrunch_client.py export INTERLEX_API_KEY=your_key_without_quotes

    python3 simple_scicrunch_client.py interlex post entity "term" ILX:0101431 "mystical neuron"
    python3 simple_scicrunch_client.py interlex post entity "term" ILX:0101431 "magical neuron" "This neuron is magical"

    python3 simple_scicrunch_client.py interlex post triple ILX:1234567 definition: "entities definition"

    # annotation logic -> <term_ilx> <annotation_ilx> <str>
    python3 simple_scicrunch_client.py interlex post triple ILX:1234567 ILX:1234568 "annotation value"

    # relationship logic -> <term1_ilx> <relationship_ilx> <term2_ilx>
    python3 simple_scicrunch_client.py interlex post triple ILX:1234567 ILX:1234568 ILX:1234569

    python3 simple_scicrunch_client.py interlex get ILX:0101431
...
class Client:
    ...
    def __init__(self, test=False):
        ...
        ### PRODUCTION ###
        self.base_path = 'https://scicrunch.org/api/1/'
