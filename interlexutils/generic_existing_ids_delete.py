...
def delete_existing_id(existing_ids, tid, subj):
    corrected_existing_ids = []
    for existing_id in existing_ids:
        if existing_id['curie'] == subj:
            continue
        else:
            corrected_existing_ids.append(existing_id)
    return corrected_existing_ids
...
filename = 'delete-go-sao-mappings'
...
for i, new_existing_id in enumerate(new_existing_ids[:]):
    ...
    existing_ids = delete_existing_id(
