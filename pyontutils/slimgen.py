...
def chebi_make():
    ...
    ng = cull_prefixes(new_graph.g, prefixes = uPREFIXES)
    ng.filename = new_graph.filename
    cd = cull_prefixes(chebi_dead.g, prefixes = uPREFIXES)
    cd.filename = chebi_dead.filename
    ng.write()
    cd.write()
