...
from pyontutils.namespaces import makePrefixes, ilxtr, ilx
...
ATLAS_SUPER = ilxtr.parcellationArtifact # 'NIFRES:nlx_res_20090402'  # alternatives?
...
class CoCoMac(genericPScheme):
    ...
    concept = PScheme(ilx['cocomac/uris/readable/BrainSiteAcronym'],
                       ...
                       'NCBITaxon:9544',
                       'ilxtr:various')
    atlas = PSArtifact(ilx['cocomac/uris/readable/BrainSiteAcronymTable'],
                        'CoCoMac terminology',
