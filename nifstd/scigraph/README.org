...
#+header: :shebang "#!/usr/bin/env bash" :tangle-mode (identity #o755)
#+begin_src bash :noweb yes :dir ./bin :tangle ./bin/run-build-services-sparc-data
./build-services \
...
#+header: :shebang "#!/usr/bin/env bash" :tangle-mode (identity #o755)
#+begin_src bash :noweb yes :dir ./bin :tangle ./bin/run-build-services-sparc-data-local
./build-services \
--path-cypher-resources <<cypher-resources-sparc-data()>> \
