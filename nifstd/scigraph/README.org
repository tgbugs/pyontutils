...
#+header: :var _PATH_ONTOLOGIES_SECTION=""
#+header: :var _BUILD_LOCATION=build-location-graph()
#+header: :var _GRAPH_FOLDER_NAME=folder-name-graph()
...
if [[ -z "${PATH_ONTOLOGIES_SECTION}" ]]; then
...
***** build
***** build sparc
Set =graph-folder-sparc= here
#+name: graph-folder-sparc
: sparc
...
#+HEADER: :shebang "#!/usr/bin/env bash" :tangle-mode (identity #o755)
#+header: :var _PATH_GRAPHLOAD=path-graphload-template()
#+header: :var _PATH_ONTOLOGIES_SECTION=path-ontologies-sparc()
#+header: :var _BUILD_LOCATION=build-location-graph()
#+header: :var _GRAPH_FOLDER_NAME=graph-folder-sparc()
...
#+HEADER: :shebang "#!/usr/bin/env bash" :tangle-mode (identity #o755)
#+header: :var _PATH_GRAPHLOAD=path-graphload-template()
#+header: :var _PATH_ONTOLOGIES_SECTION=path-ontologies-sparc-data()
#+header: :var _BUILD_LOCATION=build-location-graph()
#+header: :var _GRAPH_FOLDER_NAME=folder-name-graph-sparc-data()
...
Set =build-location-ontology= here
#+name: build-location-ontology
: ./

#+name: load-graph-ontology-base
#+header: :shebang "#!/usr/bin/env bash" :tangle-mode (identity #o755)
#+header: :var _PATH_GRAPHLOAD=path-graphload()
#+header: :var _BUILD_LOCATION=build-location-ontology()
#+BEGIN_SRC bash :tangle ./bin/load-graph-ontology-base 
...
#+header: :var _BUILD_LOCATION=build-location-graph()
#+header: :var _GRAPH_FOLDER_NAME=folder-name-graph()
#+begin_src bash :tangle ./bin/deploy-graph
: ${SERVER:="${_SERVER}"}
...
#+header: :var _GRAPH_FOLDER_NAME=folder-name-graph-services()
...
#+header: :var _PATH_CURIES=path-curies()
#+header: :var _BUILD_LOCATION=build-location-services()
#+header: :var _GRAPH_FOLDER_NAME=folder-name-graph-services-sparc-data()
#+header: :var _SVC_HOST="localhost"
#+header: :var _SVC_PORT=9000
