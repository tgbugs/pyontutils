...
Atlas = namedtuple('Atlas', ['curie', 'name', 'version', 'date', 'link', 'citation', 'synonyms','acronyms'])
Atlas('SCR:something', 'name name', 'v1', '01/01/01','http://wut.wut', 'scholarly things', tuple(), tuple())
ATLAS_SUPER = 'NIFRES:nlx_res_20090402'  # alternatives?
...
def make_atlas(atlas, parent=ATLAS_SUPER):
    out = [
        ...
        (atlas.curie, 'OBOANN:definingCitation', atlas.citation),
            ...
            [(atlas.cuire, 'OBOANN:synonym', syn) for syn in atlas.synonyns)] + \
            [(atlas.cuire, 'OBOANN:acronym', ac) for ac in atlas.acronyms)]
