...
class HCP(genericPScheme):
    ont = OntMeta('http://ontology.neuinfo.org/NIF/ttl/generated/',
                  ...
                  TODAY)
    concept = PScheme('ilx:ilx_hcp2016_parc_region',
...
class WHSSD(genericPScheme):
    ont = OntMeta('http://ontology.neuinfo.org/NIF/ttl/generated/',
                  ...
                  'This file is automatically generated from....',
                  TODAY)
    concept = PScheme('ilx:ilx_whs_sd_2_parc_region',
                      'Waxholm Space Sprague Dawley parcellation concept',
                      'NCBITaxon:10116',  # TODO
                      ADULT)  # TODO
    atlas = PSArtifact('ilx:whs_sd_v2_atlas',
    ...
    @classmethod
    def datagetter(cls):
        with open('resources/WHS_SD_rat_atlas_v2.label', 'rt') as f:
