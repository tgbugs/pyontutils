...
OntMeta = namedtuple('OntMeta', ['path','filename','PREFIXES','name','shortname','version'])
...
def make_generic_pscheme(ont, concept, atlas,
                         datasource, func):
    ontid = ont.path + ont.filename + '.ttl'
    new_graph = makeGraph(ont.filename, ont.PREFIXES)
    new_graph.add_ont(ontid, ont.name, ont.comment, ont.version, ont.shortname)
